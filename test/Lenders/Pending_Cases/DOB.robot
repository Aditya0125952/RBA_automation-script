...
DOB Pending - Applicant
    ...
    Set To Dictionary    ${modified_app}     dob=03/01/1980
...
DOB Pending - Co-Applicant
    ...
    Set To Dictionary    ${modified_app}    dob=03/01/1985
